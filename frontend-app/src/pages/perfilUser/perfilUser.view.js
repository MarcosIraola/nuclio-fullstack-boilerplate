...
const PerfilUser = () => {
    ...
    const imgPorDefecto = 'https://s.pinimg.com/images/user/default_280.png';
    const imgAvatarUser = state.user.avatar;
    ...
    return (
        <div className={styles.__contenedor}>
            ...
            <div className={styles.__foto__contenedor}>
                {imgAvatarUser ?
                    (<img src={imgAvatarUser} className={styles.__foto__usuario} alt='Error'/>)
                    :
                    (<img src={imgPorDefecto} className={styles.__foto__usuario} alt='Error'/>)
                }
            </div>
