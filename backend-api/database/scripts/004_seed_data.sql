INSERT INTO users (id, email, username, first_name, last_name, bio, email_verified_at, password, remember_token, created_at, updated_at, avatar) VALUES (1, 'test@test.com', 'testuser1', 'Test', 'User', 'I am a Test User', '2020-07-06 12:53:37', 'test123', null, '2020-07-06 12:53:46', '2020-07-06 12:53:48', 'asd');
INSERT INTO users (id, email, username, first_name, last_name, bio, email_verified_at, password, remember_token, created_at, updated_at, avatar) VALUES (2, 'another@test.com', 'anothertest', 'Another', 'Test', 'Another Test', '2020-07-06 19:49:39', 'test', null, '2020-07-06 19:49:47', '2020-07-06 19:49:50', 'asd');
